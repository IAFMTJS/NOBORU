...
function withTheme(basePath, theme) {
  return `${basePath}_${theme}_v1.png`;
}

const LEGACY_BACKGROUND_BASE = {
...
function mapNoboruCharacter(id) {
  return (
    NOBORU_BASE_MAP[id] ??
...
function mapInventoryItem(id) {
  return `props/${kebabToSnake(id)}`;
}

function mapReward(id) {
  return `achievements/${kebabToSnake(id)}`;
}

export function mapLegacyAssetToArtLibrary(ref, theme = "dark") {
