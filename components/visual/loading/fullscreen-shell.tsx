...
import { StoryTitle } from "../primitives/story-title";
import { CampCampfire } from "../camp/camp-campfire";
...
function LoadingBackground({
  ...
  profile: LoadingPresentationViewModel["profile"];
  priority?: boolean;
}) {
...
/** Mockup-aligned fullscreen / compact loading presentation. */
    ...
    >
      ...
      <div
        className={cn(
          ...
          isFullscreen
            ? "justify-end px-5 pb-safe-bottom pt-16"
      ...
      >
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <p className="text-caption uppercase tracking-[0.14em] text-muted-foreground/80">
