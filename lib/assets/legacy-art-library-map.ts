...
const LEGACY_BACKGROUND_BASE: Record<string, string> = {
  ...
  "bg-study-default": "backgrounds/study/bg_study",
  "bg-study-bamboo": "backgrounds/study/bg_study_bamboo",
  "bg-study-sakura": "backgrounds/study/bg_study_sakura",
  ...
  "bg-shrine-boss-atmosphere": "backgrounds/shrine/bg_shrine_lantern",
  "bg-shrine-locked-region": "backgrounds/shrine/bg_shrine",
