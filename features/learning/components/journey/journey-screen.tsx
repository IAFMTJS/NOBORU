...
import { JourneyPathMap } from "@/features/learning/components/journey/journey-path-map";
...
import type { JourneyNode, JourneyPathViewModel } from "@/features/learning/types/journey.types";
  ...
  return (
    <>
      <div className="relative -mx-[max(0px,calc((100vw-100%)/2))] flex h-[calc(100dvh-6rem)] min-h-0 flex-col">
        ...
        {selectedRegion.currentNodeIndex !== null ? (
          <div className="pointer-events-none fixed bottom-[8.5rem] left-1/2 z-20 max-w-[14rem] -translate-x-1/2 px-4">
            <YamaPresence
              presence={yamaService.resolveTrailProgress(
                selectedRegion.currentNodeIndex,
              )}
              size="sm"
              layout="vertical"
